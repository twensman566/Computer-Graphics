...
var inverseVertices = [
	...
	points.push( inverseVertices[ 0] );
    points.push( inverseVertices[ 1] );
    points.push( inverseVertices[ 2] );

    points.push( inverseVertices[ 0] );
    points.push( inverseVertices[ 2] );
    points.push( inverseVertices[ 3] );
	...
	//RightSide of top chevron
var inverseVertices2 = [
        vec2( 0.0, 0.0 ), //  0 
        vec2(  0.0, -0.3 ), //  1
        vec2(  0.8,  -0.8 ), //  2
        vec2( 0.8,  -0.5 ), //  3
    ];
	points.push( inverseVertices2[ 0] );
    points.push( inverseVertices2[ 1] );
    points.push( inverseVertices2[ 2] );

    points.push( inverseVertices2[ 0] );
    points.push( inverseVertices2[ 2] );
    points.push( inverseVertices2[ 3] );
