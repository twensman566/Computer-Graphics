 ...
 * These functions render texture coordinates but not normals.
 ...
 */
dividePatch = function (p, pt, count) {
  ...
  if (count <= 0) {
    ...
    dividePatch(q, qt, count - 1);
    dividePatch(r, rt, count - 1);
    dividePatch(s, st, count - 1);
    dividePatch(t, tt, count - 1);
  }
