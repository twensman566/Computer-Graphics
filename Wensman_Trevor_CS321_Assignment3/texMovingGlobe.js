...
function initPyramid() {
 ...
 const texIndices = [
  ...
  vertices[0] = vec4( 0.0, 1.0,  0.0, 1.0); // Apex
  vertices[1] = vec4(-1.0, 0.0,  1.0, 1.0); // Front Left
  vertices[2] = vec4( 1.0, 0.0,  1.0, 1.0); // Front Right
  vertices[3] = vec4( 1.0, 0.0, -1.0, 1.0); // Back Right
  vertices[4] = vec4(-1.0, 0.0, -1.0, 1.0); // Back Left
  ...
  texVecs[6] = vec2(0.0,           tRepeat); // Base 3
